      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center">
          <Button 
            ...
            className="bg-slate-900 hover:bg-slate-800 text-white px-8 py-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
          >
            Get Started
          </Button>
        </div>
